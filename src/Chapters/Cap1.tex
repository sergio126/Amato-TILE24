...
Per suono intendiamo un'alterazione di pressione, velocità e posizione delle particelle, propagata in un mezzo elastico, o la sovrapposizione di tali alterazioni.
...
\begin{itemize}
      \item Periodo: Il tempo di completamento di un ciclo (ovvero quando, un segnale periodico esprime tutti i suoi valori ricorrenti) espresso in secondi
      \item Frequenza: il numero di cicli in 1 secondo, si esprime in hertz

      \item Lunghezza d'onda: la distanza tra 2 massimi consecutivi, si esprime in metri

      \item Ampiezza: massima escursione dal punto di equilibrio

      \item Velocità dell'onda: velocità di movimento del fronte d'onda nel mezzo, si esprime in metri al secondo.
